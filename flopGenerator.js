class flopGenerator {
    ...
    generateInsideStraight(hole1, hole2) { 
        ...
        //Now you have 52 cards with the appropriate mapping (either A of clubs = 13c or 1c)

        //Remove hole cards from the 52 cards

        //Now you have 50 cards, with the hole cards removed
        ...
        //Make sure you remove this from the original deck
        ...
        if(/* hole cards seperated by 3 clicks */) {
            //Select & remove 1 internal card, remove remaining cards with with equivalent value
            //Select & remove 1 internal card, remove remaining cards with with equivalent value
            ...
            if (/* probability function with probablity of NoOfInternalCards/NoOfInternalCards + NoOfExternalCards of being true*/ ) {
                ...
                //Select & remove 1 external card, remove remaining cards with equivalent value
            }
